...
/** return an array from assoc-$ay containing fields as specified in [$boolLvs] will be converted from '0-1' to true-false  */
...
/** return an array from assoc-$ay containing fields specified in [$timLvs] will be converted from '0-1' to true-false  */
function ay_convert_tim(array $ay, $timLvs)
{
    $a = split_lvs($timLvs);
    $o = $ay;
    foreach ($a as $fld) {
...
function is_main()
{
    ...
    return (@$_SERVER['argv'][0] === @$_SERVER['SCRIPT_FILENAME']);
}

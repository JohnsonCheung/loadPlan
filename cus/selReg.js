(function (angular, _) {
    ...
    function leftControllerFn($scope, $http, $doc, getOptObj, selCol, swapAyEle) {
        $http.get("../phpResp/lbl.php?pgmNm=selReg&secNm=sel").success(function (data) {
            $scope.lbl = data;
        });
        ...
        $scope.btn2Nm = "chi";
        $scope.btn3Nm = "eng";
        $scope.btn_selected = getOptObj("inp cod chi eng");
//        $scope.lbl = lbl;
        $scope.selectedIdx = 0;
        ...
        function success(data, status, headers, config) {
            ...
            data = selCol(src.data, btn_selected, b0, b1, b2, b3);
            $scope.tar.data = data;
        }
        ...
        function do_filter_changed(filter) {
            ...
            function bld_data(data) {
                ...
                return selCol(data, btn_selected, btn0Nm, btn1Nm, btn2Nm, btn3Nm);
            }
        }
        ...
        function do_bld_data() {
            ...
            var b2 = $scope.btn2Nm;
            var b3 = $scope.btn3Nm;
            $scope.tar.data = selCol(src_data, btn_selected, b0, b1, b2, b3)
        }
        ...
        function ondrop(ev) {
            ...
            var src_data = $scope.src.data;
            var btn_selected = $scope.btn_selected;
            var new_data = selCol(src_data, btn_selected, b0, b1, b2, b3);

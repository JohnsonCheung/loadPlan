...
Debug.Assert FillHdr.DriverTy = "DriverTy1"
Debug.Assert FillHdr.A_Ft = "C:\xampp\htdocs\loadPlan\pgm\loadSheet\Que\Trip-2015-01-01#001\hdr.txt"
...
Set Wb = WbNew
FillWs1.Init C_Fdr
Set Ws = FillWs1.AddWs(Wb)
FillWs1.FillHdr.Fillin Ws
Stop
Wb.Close False
